Guidance for working in **omac** — an Omarchy-style, keyboard-driven, fully-themed desktop _layer_
...
- **[Omarchy](https://github.com/basecamp/omarchy)** — the north star. Its themes, keyboard-driven
  desktop, and XDG layout are what omac ports to macOS. When in doubt about _what_ a feature should
  do, ask "what does Omarchy do?"
- **[Omakos](https://github.com/yatish27/omakos)** — the model for idempotent, re-runnable,
  declarative Homebrew provisioning. When in doubt about _how_ to install/deploy safely, follow
...
(appearance, JankyBorders, Raycast, Chrome, AeroSpace). `omac theme set` repoints the `~/.config/omac/current`
